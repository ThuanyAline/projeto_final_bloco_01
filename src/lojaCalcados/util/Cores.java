package lojaCalcados.util;

public class Cores {
	// PARA RESERTAR AS CORES
		public static final String TEXT_RESET = "\u001B[0m";

		// TEXT COLOR INSERINDO AS CORES
		...
		public static final String ANSI_CYAN_BACKGROUND = "\u001B[46";
		public static final String ANSI_WHITE_BACKGROUND = "\u001B[47";

		//// BLACKGROUD COLOR HIGH INTENSITY
		...
		public static final String ANSI_PURPLE_BACKGROUND_BRIGHT = "\0330[0;105m";
